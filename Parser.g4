...
boolDecl : BOOL boolArrDeclList SEMICOLON;
intDecl : INT intArrDeclList SEMICOLON;
charDecl : CHAR charArrDeclList SEMICOLON;
floatDecl : FLOAT floatArrDeclList SEMICOLON;

scopedVarDecl : typeSpec varDeclList SEMICOLON   //todo
	    | typeSpec arrDeclList SEMICOLON;
...
boolSimpleExp : boolSimpleExp OR andExp | andExp;
...
relExp : boolSimpleExp relop boolSimpleExp;

relExp : intSimpleExp relop intSimpleExp;

relExp : charSimpleExp relop charSimpleExp;

relExp : floatSimpleExp relop floatSimpleExp;
